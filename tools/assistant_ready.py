...
from knowledge_hub.services import build_assistant_ready_pack, render_assistant_ready_text


def main() -> int:
    parser = argparse.ArgumentParser(description="Export an assistant-ready project brief.")
    ...
    if args.format == "json":
        print(json.dumps(assistant_pack, ensure_ascii=False, indent=2))
    else:
        print(render_assistant_ready_text(assistant_pack))
    return 0
